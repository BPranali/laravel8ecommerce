                        ...
                        <div class="detail-media">
                            <div class="product-gallery">
                                ...
                                <div class="flex-viewport" style="overflow: hidden; position: relative;">
                                    <ul class="slides"
                                        style="width: 2000%; transition-duration: 0s; transform: translate3d(-2820px, 0px, 0px);">
                                        <li data-thumb="{{ asset('/images/product') }}/{{ $product->image }}" class="clone"
                                            aria-hidden="true"
                                            style="width: 470px; margin-right: 0px; float: left; display: block;">
                                            <img src="{{ asset('/images/product') }}/{{ $product->image }}"
                                                alt="product thumbnail" draggable="false">
                                        </li>
                        ...
                        <div class="wrap-products">
                            <div class="products slide-carousel owl-carousel style-nav-1 equal-container owl-loaded owl-drag"
                                ...
                                <div class="owl-stage-outer">
                                    <div class="owl-stage"
                                        style="transform: translate3d(0px, 0px, 0px); transition: all; width: 1869px;">
                                            ...
                                            <div class="product product-style-2 equal-elem " style="height: 316px;">
                                                <div class="product-thumnail">
                                                    <a href="detail.html"
                                                        ...
                                                        <figure><img src="assets/images/products/digital_04.jpg"
                                                ...
                                                <div class="product-info">
                                                    <a href="#" class="product-name"><span>Radiant-360 R6
                                                            Wireless Omnidirectional Speaker [White]</span></a>
                                        ...
                                        <div class="owl-item" style="width: 233.6px;">
                                            <div class="product product-style-2 equal-elem " style="height: 316px;">
                                                <div class="product-thumnail">
                                                    <a href="detail.html"
                                                        title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                                        <figure><img src="assets/images/products/digital_03.jpg"
                                                                width="214" height="214"
                                                                alt="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                                        </figure>
                                                    </a>
                                ...
                                <div class="owl-nav"><button type="button" role="presentation"
                                        class="owl-prev disabled"><i class="fa fa-angle-left"
